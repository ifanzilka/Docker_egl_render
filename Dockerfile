...
RUN wget https://download.blender.org/release/Blender4.2/blender-4.2.1-linux-x64.tar.xz
RUN tar -xf blender-4.2.1-linux-x64.tar.xz

COPY entrypoint.sh /workspace/entrypoint.sh
RUN chmod 755 /workspace/entrypoint.sh

COPY blend_multi_universal.py /workspace/blend_multi_universal.py
COPY blender_script_universal.py /workspace/blender_script_universal.py

COPY ./tmp_glb /workspace/tmp_glb
...
#vglrun glxinfo -B
#docker build -t docker_blender_egl .
#docker run -it --gpus all -d --name docker_blender_container_egl docker_blender_egl
#docker exec -it 7e5fcfd4e642 bash
